...
- Treat near-equal, same-source, short-window CEX fan-out as common-control evidence; direction stays unknown until next-hop, redeposit, DEX execution, and quote-recovery checks resolve it.
...
- If a verified sibling cluster is actively distributing, block follow language generated by another cluster's accumulation signal; classify the operator phase as mixed and move held exposure to Reduce watch when sell evidence is confirmed.
...
- `references/miles082510-wallet-cluster-review-2026-07-13.md`: `@Miles082510` CEX-withdrawal fan-out, operator phase, cluster-conflict, signal-lag, and dashboard-field review.
